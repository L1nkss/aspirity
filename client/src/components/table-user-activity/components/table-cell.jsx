...
const TableCell = (props) => {
    const { activity, comment, distance, date, id} = props;

    const userData = {activity, comment, distance, date, id };
    ...
    return (
        <tr>
            ...
            <td>
                <FieldModal submitHandler={changeActivity} activityInfo={userData} render={(callback) => (
